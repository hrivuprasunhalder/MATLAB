...
% Secular equilibrium: 144Ce -> 144Pr
T1_parent = 284.91*24*3600
T1_daughter = 17.28*60;
...
figure; hold on;
plot(t/3600, A1,'r','LineWidth',1.5,'DisplayName','144-Ce');
plot(t/3600, A2,'b','LineWidth',1.5,'DisplayName','144-Pr');
xlabel('Time (hours)');
ylabel('Activity');
title('Secular Equilibrium: ^{144}Ce -> ^{144}Pr');
